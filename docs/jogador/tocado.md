...
**Traço passivo — Brasa Interna:** [Resistência](../jogador/sistema-d20.md#resistencia-imunidade-e-vulnerabilidade) a fogo, e **imune** à condição [Queimando](../glossario.md#queimando) — o fogo não tem o que acrescentar nele.
...
**Traço passivo — Fora de Lugar:** 1x por [descanso longo](../mestre/exploracao.md#descanso), como **Reação** e sem custo de Mana, teleporta-se até o valor do próprio Movimento para um ponto visível. Funciona mesmo estando [Imóvel](../glossario.md#imovel) ou agarrado — ele não se move, ele deixa de estar ali.
