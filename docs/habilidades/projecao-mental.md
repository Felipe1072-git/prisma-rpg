# Habilidades de Projeção Mental

Telepatia, ler mentes, ilusão mental, dano psíquico — funciona em qualquer mente, sem depender de palavras.
...
- **Intensidade I — ◈ (1 PA) + 9 Mana:** por 1 rodada, cria uma ilusão visual ou sonora simples (uma forma, um som) na área — não interage fisicamente com nada, mas engana quem não investigar de perto.
- **Intensidade II — ◈◈ (2 PA) + 18 Mana:** por 2 rodadas, a ilusão pode se mover e imitar uma criatura ou efeito conhecido (um aliado, uma explosão, um grito); quem agir contra ela perde a ação, sem efeito real.
...
- **Chave:** [Projeção Mental](../glossario.md#projecao-mental)
- **Custo fixo:** ◈ (1 PA) + 6 Mana | **Atributo:** Magia | **Alcance:** 12 casas | **Alvos:** até 5 aliados conhecidos pelo usuário
...
- **Chave:** [Projeção Mental](../glossario.md#projecao-mental)
- **Atributo:** Magia | **Dano:** Impacto | **Alcance:** 6 casas | **Alvos:** 1 objeto pequeno e solto (do tamanho de uma espada pra baixo); ou 1 criatura, só na Intensidade III
- **Intensidade I — ◈ (1 PA) + 3 Mana:** desloca o objeto até 3 casas, ou realiza uma ação simples nele (puxar alavanca, girar chave, abrir uma porta destrancada). Automático, sem teste.
- **Intensidade II — ◈◈ (2 PA) + 9 Mana:** o mesmo, e pode manter o objeto suspenso no ar até o fim do próximo turno do usuário. Automático, sem teste.
- **Intensidade III — ◈◈◈ (3 PA) + 18 Mana:** arremessa o objeto contra 1 criatura (d100 + Magia vs Evasão): 1d4 de dano de Impacto se acertar
- **Crítico (só ao arremessar na Intensidade III):** dano máximo (4) + 1d4 extra
...
- **Custo fixo:** ◈◈◈ (3 PA) + 48 Mana | **Atributo:** Magia | **Alcance:** 8 casas | **Alvos:** 1 casa livre de tamanho Grande dentro do alcance
- **Efeito:** conjura uma mão espectral gigante na casa escolhida (Vida 20, Evasão 14). Dura 3 rodadas, ou até ser destruída. No instante em que é conjurada, e como ação livre no início de cada um dos próprios turnos seguintes do usuário enquanto durar, ele escolhe um comando pra ela executar:
  - **Golpear** — teste de ataque (d100 + Magia) contra a Evasão de 1 criatura adjacente à mão; acertando, 3d10 de dano de Impacto.
  - **Agarrar** — 1 criatura Grande ou menor adjacente à mão testa Ataque ou Agilidade (o maior) contra a Evasão do usuário; falhando, fica [Agarrada](../glossario.md#agarrado) pela mão.
  - **Empurrar** — 1 criatura adjacente à mão testa Ataque contra a Evasão do usuário; falhando, é empurrada até 4 casas.
