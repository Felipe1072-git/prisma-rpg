# Habilidades de Espaço-Tempo

Reposicionar à força, distorcer gravidade e manipular o fluxo do tempo — teleporte, puxar,
empurrar, ganhar uma ação extra, refazer um resultado que já aconteceu.
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Custo fixo:** ◈◈ (2 PA) + 21 Mana | **Atributo:** Magia | **Alcance:** 8 casas | **Alvos:** 2 casas de raio do ponto
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Custo fixo:** 0 PA + 27 Mana | **Atributo:** Magia | **Alvos:** o próprio usuário
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Custo fixo:** ◈◈ (2 PA) + 24 Mana | **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** 1 criatura
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Custo fixo:** ◈◈◈ (3 PA) + 48 Mana | **Atributo:** Magia | **Resolução:** Teste de Resistência | **Vs:** Magia | **Dano:** Arcano | **Alcance:** 8 casas | **Alvos:** 4 casas de raio do ponto
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Custo fixo:** ◈◈◈ (3 PA) + 48 Mana | **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 8 casas (centro) | **Alvos:** todas as criaturas hostis em 3 casas de raio do ponto
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Custo fixo:** ◈◈◈ (3 PA) + 48 Mana | **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 10 casas | **Alvos:** até 3 pontos diferentes, 1 casa de raio cada
...
- **Intensidade II — ◈◈ (2 PA) + 15 Mana:** 1d10 de dano + derruba o alvo, e ele perde a próxima Reação
...
- **Chave:** [Espaço-Tempo](../glossario.md#espaco-tempo)
- **Atributo:** Magia | **Alcance:** 8 casas | **Alvos:** 1 criatura (aliada ou hostil)
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 18 Mana:** depois que uma criatura a até 8 casas fizer qualquer teste de d100 e o resultado for revelado, o usuário pode usar esta habilidade como Reação pra forçar aquele teste a ser refeito — o novo resultado vale, mesmo que seja pior.
- **Intensidade II — 0 PA + 27 Mana:** o mesmo; se o alvo for aliado, o novo teste rola com [Vantagem](../glossario.md#vantagem).
- **Intensidade III — 0 PA + 36 Mana:** o mesmo; se o alvo for hostil, o novo teste rola com [Desvantagem](../glossario.md#desvantagem) (o efeito da Intensidade II continua valendo quando o alvo for aliado).
