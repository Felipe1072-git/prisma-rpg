...
Drenar vigor, amaldiçoar, erguer mortos, gastar a própria vitalidade.
...
- **Atributo:** Magia | **Alvos:** 1 criatura, corpo a corpo
- **Intensidade I — ◈ (1 PA) + 6 Mana:** 1d6 de dano, e o usuário recupera Vida igual à metade do dano causado
- **Intensidade II — ◈◈ (2 PA) + 15 Mana:** 1d8 de dano, e o usuário recupera Vida igual ao dano causado
...
- **Intensidade I — ◈ (1 PA) + 15 Mana:** por 2 rodadas, os ataques do usuário que causarem dano também deixam o alvo [Sangrando](../glossario.md#sangrando) — não empilha num mesmo alvo.
...
- **Intensidade I — ◈ (1 PA) + 6 Mana:** 1d4 de dano + alvo perde 1d4 de Vida no início do próprio próximo turno.
- **Intensidade II — ◈◈ (2 PA) + 15 Mana:** 1d6 de dano + alvo perde 1d4 de Vida no início do próximo turno dele, e mais 2d4 no início do turno seguinte a esse (a praga piora a cada disparo).
...
- **Chave:** [Necromancia](../glossario.md#necromancia)
- **Custo fixo:** ◈◈◈ (3 PA) + 36 Mana | **Atributo:** Magia | **Alcance:** 3 casas | **Alvos:** 1 aliado morto, cujo corpo ainda esteja na cena
...
- **Chave:** [Necromancia](../glossario.md#necromancia)
- **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 8 casas | **Alvos:** 1 criatura
- **Intensidade I — ◈ (1 PA) + 6 Mana:** 1d6 de dano + até o fim do próximo turno do alvo, qualquer Resistência a dano que ele tenha é ignorada.
- **Intensidade II — ◈◈ (2 PA) + 15 Mana:** 1d8 de dano + o mesmo, por 2 rodadas, e o alvo perde 2 de Evasão nesse período.
- **Intensidade III — ◈◈◈ (3 PA) + 24 Mana:** 2d8 de dano + o mesmo, por 3 rodadas, e qualquer Imunidade a dano do alvo vira apenas Resistência nesse período.
- **Crítico:** dano máximo dos dados da Intensidade usada + uma rolagem extra igual, e sobe 1 Intensidade
...
- **Chave:** [Necromancia](../glossario.md#necromancia)
- **Atributo:** Magia | **Dano:** Arcano | **Alvos:** 1 criatura, corpo a corpo
- **Intensidade I — ◈ (1 PA) + 6 Mana:** 1d8 de dano; se isso deixar o alvo com menos da metade da Vida máxima, o usuário recupera 1d4 de Mana.
- **Intensidade II — ◈◈ (2 PA) + 15 Mana:** 1d10 de dano, com +1d8 extra se o alvo já estiver com menos da metade da Vida máxima; o usuário recupera 1d4 de Mana se isso acontecer.
- **Intensidade III — ◈◈◈ (3 PA) + 24 Mana:** 2d10 de dano, com +2d8 extra se o alvo já estiver com menos da metade da Vida máxima; o usuário recupera 2d4 de Mana se isso acontecer.
- **Crítico:** dano máximo dos dados da Intensidade usada + 1d8 extra, e sobe 1 Intensidade
...
- **Chave:** [Necromancia](../glossario.md#necromancia)
- **Atributo:** Magia | **Dano:** Arcano | **Alvos:** 1 criatura adjacente
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 9 Mana:** quando uma criatura entrar numa casa adjacente ao usuário, ou terminar o próprio turno lá, ele pode usar esta habilidade como Reação pra causar 1d4 de dano automático nela.
- **Intensidade II — 0 PA + 18 Mana:** o mesmo, causando 1d6.
- **Intensidade III — 0 PA + 27 Mana:** o mesmo, causando 1d8.
...
- **Chave:** [Necromancia](../glossario.md#necromancia)
- **Custo fixo:** ◈◈◈ (3 PA) + 48 Mana | **Atributo:** Magia | **Dano:** Arcano | **Alvos:** 1 criatura, corpo a corpo
