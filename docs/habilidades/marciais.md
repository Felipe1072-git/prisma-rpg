...
- **Custo:** 3 Mana | ◈◈◈ (3 PA) | **Atributo:** Força | **Alvos:** o próprio usuário
...
- *(Sem Tiers de Sucesso — habilidade de buff, não de ataque)*
...
- **Chave:** [Marciais](../glossario.md#marciais) - [Especial](../glossario.md#especial)
- **Custo:** 3 Mana | ◈◈◈ (3 PA) | **Atributo:** Força (ou Agilidade, se a arma equipada for Finesse) | **Alvos:** até 3 criaturas à escolha, ao alcance da arma equipada
- **Dano:** usa o dado de dano da arma equipada
...
- **Tier 1 (≤10):** dano desarmado, usuário se desloca até 2 casas em direção ao alvo
...
- **Chave:** [Marciais](../glossario.md#marciais)
- **Custo:** 2 Mana | ◈◈ (2 PA) | **Atributo:** Força | **Alcance do avanço:** até o valor de Movimento, em casas | **Alvos:** 1 criatura
- **Dano:** usa o [Dano Desarmado](#dano-desarmado)
- **Tier 1 (≤10):** dano desarmado, usuário se desloca até o alvo
- **Tier 2 (11–16):** dano desarmado + derruba o alvo
- **Tier 3 (≥17):** dano desarmado + derruba o alvo + alvo perde a próxima Reação
- **Crítico:** dano desarmado máximo + rolagem extra + derruba + perde Reação
...
- **Chave:** [Marciais](../glossario.md#marciais)
- **Custo:** 2 Mana | ◈◈ (2 PA) | **Atributo:** Força (ou Agilidade, se a arma equipada for Finesse) | **Alcance:** 8 casas | **Alvos:** 1 criatura
- **Dano:** usa o dado de dano da arma equipada
- **Tier 1 (≤10):** 1x dado de dano
- **Tier 2 (11–16):** 1x dado de dano + empurra 1 casa
- **Tier 3 (≥17):** 1x dado de dano + derruba o alvo
