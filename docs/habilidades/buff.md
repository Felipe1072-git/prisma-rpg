...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 4 Mana:** por 2 rodadas, o usuário não pode ser derrubado por nenhuma habilidade.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário, e aliados em 2 casas de raio
- **Intensidade I — ◈ (1 PA) + 4 Mana:** por 3 rodadas, o usuário ganha +1d4 de dano em ataques corpo a corpo e +2 de Movimento. Aliados dentro de 2 casas do usuário ganham +1 de dano em ataques corpo a corpo enquanto permanecerem na área.
- **Intensidade II — ◈◈ (2 PA) + 7 Mana:** por 3 rodadas, o usuário ganha +2d4 de dano em ataques corpo a corpo e +3 de Movimento. Aliados dentro de 2 casas do usuário ganham +2 de dano em ataques corpo a corpo enquanto permanecerem na área.
- **Intensidade III — ◈◈◈ (3 PA) + 10 Mana:** por 3 rodadas, o usuário ganha +3d4 de dano em ataques corpo a corpo e +4 de Movimento. Aliados dentro de 2 casas do usuário ganham +3 de dano em ataques corpo a corpo enquanto permanecerem na área.
...
- **Atributo:** Força | **Alvos:** o próprio usuário
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 3 Mana:** quando for alvo de um ataque corpo a corpo, o usuário pode usar esta habilidade como Reação pra ganhar um Escudo de 1d6 pontos contra aquele ataque, absorvendo o dano antes da Vida ser afetada.
- **Intensidade II — 0 PA + 6 Mana:** quando for alvo de um ataque corpo a corpo, o usuário pode usar esta habilidade como Reação pra ganhar um Escudo de 2d6 pontos contra aquele ataque, absorvendo o dano antes da Vida ser afetada.
- **Intensidade III — 0 PA + 9 Mana:** quando for alvo de um ataque corpo a corpo, o usuário pode usar esta habilidade como Reação pra ganhar um Escudo de 3d6 pontos contra aquele ataque, absorvendo o dano antes da Vida ser afetada.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 4 Mana:** por 2 rodadas, o usuário ganha +1d4 de dano em ataques corpo a corpo e +1 de Defesa.
- **Intensidade II — ◈◈ (2 PA) + 7 Mana:** por 2 rodadas, o usuário ganha +2d4 de dano em ataques corpo a corpo e +2 de Defesa.
- **Intensidade III — ◈◈◈ (3 PA) + 10 Mana:** por 2 rodadas, o usuário ganha +3d4 de dano em ataques corpo a corpo e +3 de Defesa.
...
- **Intensidade I — ◈ (1 PA) + 6 Mana:** o alvo ganha um Escudo de 2d6 pontos, que absorve dano antes da Vida ser afetada. Dura até o fim do próximo turno do alvo, ou até ser destruído.
- **Intensidade II — ◈◈ (2 PA) + 9 Mana:** o alvo ganha um Escudo de 3d6 pontos, que absorve dano antes da Vida ser afetada. Dura até o fim do próximo turno do alvo, ou até ser destruído.
- **Intensidade III — ◈◈◈ (3 PA) + 12 Mana:** o alvo ganha um Escudo de 4d6 pontos, que absorve dano antes da Vida ser afetada. Dura até o fim do próximo turno do alvo, ou até ser destruído.
...
- **Atributo:** Inteligência | **Alvos:** o próprio usuário
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 4 Mana:** quando for alvo de um ataque, o usuário pode usar esta habilidade como Reação pra evitar completamente o dano daquele ataque, e recupera 1d4 de Vida.
- **Intensidade II — 0 PA + 7 Mana:** quando for alvo de um ataque, o usuário pode usar esta habilidade como Reação pra evitar completamente o dano daquele ataque, e recupera 2d4 de Vida.
- **Intensidade III — 0 PA + 10 Mana:** quando for alvo de um ataque, o usuário pode usar esta habilidade como Reação pra evitar completamente o dano daquele ataque, e recupera 3d4 de Vida.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 4 Mana:** por 2 rodadas, o usuário pode se mover através de casas ocupadas por outras criaturas livremente, como se elas não estivessem lá.
- **Intensidade II — ◈◈ (2 PA) + 7 Mana:** por 3 rodadas, o usuário pode se mover através de casas ocupadas por outras criaturas livremente, como se elas não estivessem lá.
- **Intensidade III — ◈◈◈ (3 PA) + 10 Mana:** por 4 rodadas, o usuário pode se mover através de casas ocupadas por outras criaturas livremente, como se elas não estivessem lá.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** 1 criatura (o atacante)
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 4 Mana:** quando for alvo de um ataque corpo a corpo, o usuário pode usar esta habilidade como Reação pra anular completamente aquele ataque, e puxar o atacante 2 casas em direção a si.
- **Intensidade II — 0 PA + 7 Mana:** quando for alvo de um ataque corpo a corpo, o usuário pode usar esta habilidade como Reação pra anular completamente aquele ataque, e puxar o atacante 3 casas em direção a si.
- **Intensidade III — 0 PA + 10 Mana:** quando for alvo de um ataque corpo a corpo, o usuário pode usar esta habilidade como Reação pra anular completamente aquele ataque, e puxar o atacante 4 casas em direção a si.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 5 Mana:** por 2 rodadas, o usuário ganha +1 no dano de ataques, +2 de Defesa, e +2 de Movimento.
- **Intensidade II — ◈◈ (2 PA) + 8 Mana:** por 2 rodadas, o usuário ganha +2 no dano de ataques, +3 de Defesa, e +3 de Movimento.
- **Intensidade III — ◈◈◈ (3 PA) + 11 Mana:** por 2 rodadas, o usuário ganha +3 no dano de ataques, +4 de Defesa, e +4 de Movimento.
...
- **Intensidade I — ◈ (1 PA) + 5 Mana:** por 3 rodadas, os alvos ganham +2 de Defesa.
- **Intensidade II — ◈◈ (2 PA) + 8 Mana:** por 4 rodadas, os alvos ganham +3 de Defesa.
- **Intensidade III — ◈◈◈ (3 PA) + 11 Mana:** por 5 rodadas, os alvos ganham +4 de Defesa.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 3 Mana:** por 2 rodadas, o usuário ganha +3 de Movimento.
- **Intensidade II — ◈◈ (2 PA) + 6 Mana:** por 2 rodadas, o usuário ganha +4 de Movimento.
- **Intensidade III — ◈◈◈ (3 PA) + 9 Mana:** por 2 rodadas, o usuário ganha +5 de Movimento.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Inteligência | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 5 Mana:** por 2 rodadas, os ataques do usuário que causarem dano também fazem o alvo perder a próxima Reação — não empilha num mesmo alvo.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Custo fixo:** ◈◈ (2 PA) + 5 Mana | **Atributo:** Inteligência | **Alvos:** o próprio usuário
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Inteligência | **Alvos:** usuário e aliados em 3 casas de raio
- **Intensidade I — ◈ (1 PA) + 5 Mana:** por 2 rodadas, os alvos ganham +1 no dano de ataques.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Inteligência | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 5 Mana:** por 3 rodadas, o usuário perde 2 de Defesa e ganha +1d4 no dano de ataques.
- **Intensidade II — ◈◈ (2 PA) + 8 Mana:** por 3 rodadas, o usuário perde 2 de Defesa e ganha +2d4 no dano de ataques.
- **Intensidade III — ◈◈◈ (3 PA) + 11 Mana:** por 3 rodadas, o usuário perde 2 de Defesa e ganha +3d4 no dano de ataques.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Força | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 4 Mana:** por 3 rodadas, o usuário ganha +1d4 no dano de ataques.
- **Intensidade II — ◈◈ (2 PA) + 7 Mana:** por 3 rodadas, o usuário ganha +2d4 no dano de ataques.
- **Intensidade III — ◈◈◈ (3 PA) + 10 Mana:** por 3 rodadas, o usuário ganha +3d4 no dano de ataques.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Inteligência | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 8 Mana:** por 2 rodadas, o usuário ganha +4 de Defesa.
- **Intensidade II — ◈◈ (2 PA) + 11 Mana:** por 2 rodadas, o usuário ganha +5 de Defesa.
- **Intensidade III — ◈◈◈ (3 PA) + 14 Mana:** por 2 rodadas, o usuário ganha +6 de Defesa.
...
- **Intensidade I — ◈ (1 PA) + 8 Mana:** por 3 rodadas, o usuário escolhe 1 dos 3 espíritos abaixo pra canalizar, podendo trocar de espírito gastando uma Reação (no máximo uma vez por rodada):
- **Intensidade II — ◈◈ (2 PA) + 11 Mana:** por 4 rodadas, o usuário escolhe 1 dos 3 espíritos abaixo pra canalizar, podendo trocar de espírito gastando uma Reação (no máximo uma vez por rodada):
- **Intensidade III — ◈◈◈ (3 PA) + 14 Mana:** por 5 rodadas, o usuário escolhe 1 dos 3 espíritos abaixo pra canalizar, podendo trocar de espírito gastando uma Reação (no máximo uma vez por rodada):
...
- **Chave:** [Buff](../glossario.md#buff)
- **Atributo:** Agilidade ou Inteligência | **Alvos:** o próprio usuário
- **Intensidade I — ◈ (1 PA) + 6 Mana:** por 2 rodadas, o usuário pode se mover livremente através de criaturas e de obstáculos sólidos (paredes, portas fechadas), como se não estivessem lá. Não pode terminar o movimento dentro de um obstáculo sólido.
- **Intensidade II — ◈◈ (2 PA) + 9 Mana:** por 3 rodadas, o usuário pode se mover livremente através de criaturas e de obstáculos sólidos (paredes, portas fechadas), como se não estivessem lá. Não pode terminar o movimento dentro de um obstáculo sólido.
- **Intensidade III — ◈◈◈ (3 PA) + 12 Mana:** por 4 rodadas, o usuário pode se mover livremente através de criaturas e de obstáculos sólidos (paredes, portas fechadas), como se não estivessem lá. Não pode terminar o movimento dentro de um obstáculo sólido.
...
- **Intensidade I — ◈ (1 PA) + 4 Mana:** por 2 rodadas, trocar a arma equipada não consome nenhuma ação. O primeiro ataque feito com uma arma diferente da usada no ataque anterior, nesse período, rola com vantagem.
- **Intensidade II — ◈◈ (2 PA) + 7 Mana:** por 3 rodadas, trocar a arma equipada não consome nenhuma ação. O primeiro ataque feito com uma arma diferente da usada no ataque anterior, nesse período, rola com vantagem.
- **Intensidade III — ◈◈◈ (3 PA) + 10 Mana:** por 4 rodadas, trocar a arma equipada não consome nenhuma ação. O primeiro ataque feito com uma arma diferente da usada no ataque anterior, nesse período, rola com vantagem.
...
- **Chave:** [Buff](../glossario.md#buff)
- **Custo fixo:** 0 PA + 3 Mana (dedicada a Reação) | **Atributo:** Força | **Alvos:** 1 aliado adjacente
