...
- **Atributo:** Magia | **Alvos:** até 3 criaturas aliadas em 3 casas de raio
- **Intensidade I — ◈ (1 PA) + 12 Mana:** cada alvo recupera 2d6 + Magia de Vida
...
- **Intensidade I — ◈ (1 PA) + 18 Mana:** por 3 rodadas, no início de cada rodada, cada alvo recupera 1d4 + Magia de Vida. Se isso trouxer um aliado caído de volta a 1 ou mais pontos de Vida, ele revive automaticamente.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Custo fixo:** ◈◈◈ (3 PA) + 54 Mana | **Atributo:** Magia | **Alvos:** 1 aliado morto a até 3 casas
- **Teste:** d100 + Magia
- **≤ 50:** falha total — o espírito do aliado se perde de vez. Ele não pode mais ser trazido de volta, por essa ou qualquer outra habilidade
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alvos:** usuário e aliados em 3 casas de raio
- **Intensidade I — ◈ (1 PA) + 18 Mana:** cada alvo recupera 2d4 + Magia de Vida imediatamente ao usar, e mais 1d4 de Vida no início de cada uma das 2 rodadas seguintes (3 aplicações no total)
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alvos:** usuário e aliados em 3 casas de raio
- **Intensidade I — ◈ (1 PA) + 12 Mana:** cada alvo recupera 1d6 de Mana imediatamente.
- **Intensidade II — ◈◈ (2 PA) + 21 Mana:** cada alvo recupera 2d6 de Mana imediatamente.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alvos:** usuário e aliados em 3 casas de raio
- **Intensidade I — ◈ (1 PA) + 18 Mana:** cada alvo recupera 1d8 + Magia de Vida imediatamente ao usar, e mais 1d4 de Vida no início de cada um dos 2 turnos seguintes do usuário.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 6 casas | **Alvos:** 1 criatura (dano) + usuário e aliados em 3 casas de raio (cura)
- **Intensidade I — ◈ (1 PA) + 15 Mana:** o alvo sofre 1d6 de dano imediatamente ao usar (rola teste de ataque contra a Evasão dele). Usuário e aliados na área recuperam 1d6 + Magia de Vida.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alvos:** usuário e aliados em 3 casas de raio
- **Intensidade I — ◈ (1 PA) + 15 Mana:** cada alvo recupera 1d8 de Mana imediatamente.
- **Intensidade II — ◈◈ (2 PA) + 24 Mana:** cada alvo recupera 2d8 de Mana imediatamente.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Custo fixo:** ◈◈ (2 PA) + 15 Mana | **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** 1 aliado
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Custo fixo:** ◈◈ (2 PA) + 24 Mana | **Atributo:** Magia | **Alcance:** 3 casas | **Alvos:** 1 criatura
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Custo fixo:** ◈ (1 PA) + 12 Mana | **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 6 casas | **Alvos:** 1 aliado
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** 1 aliado
- **Intensidade I — ◈ (1 PA) + 9 Mana:** o aliado ganha um **d6 guardado** — pode somá-lo a qualquer teste ou rolagem de dano dele, a qualquer momento antes do fim da [cena](../glossario.md#cena). Não usado, se perde no fim da cena.
- **Intensidade II — ◈◈ (2 PA) + 18 Mana:** o mesmo, com um **d8** guardado
...
- **Ao ativar, escolha um:** se o alvo for aliado, ele recupera Vida; se for hostil, sofre dano (rola teste de ataque contra a Fortitude Mágica dele)
- **Intensidade I — ◈ (1 PA) + 9 Mana:** cura 1d8 + Magia de Vida, ou 1d8 de dano
- **Intensidade II — ◈◈ (2 PA) + 18 Mana:** cura 2d8 + Magia de Vida, ou 2d8 de dano
- **Intensidade III — ◈◈◈ (3 PA) + 27 Mana:** cura 3d8 + Magia de Vida, ou 3d8 de dano
- **Crítico (só no lado de dano):** dano máximo dos dados da Intensidade usada + 1d8 extra, e sobe 1 Intensidade
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** qualquer número de aliados feridos a até 6 casas, à escolha do usuário
- **Limite por alvo:** nenhum aliado pode receber, nesta ativação, mais Vida do que metade da própria Vida máxima
- **Intensidade I — ◈ (1 PA) + 18 Mana:** um total de 4d6 + Magia de Vida é dividido entre os alvos escolhidos, como o usuário preferir
- **Intensidade II — ◈◈ (2 PA) + 27 Mana:** o mesmo, com um total de 6d6 + Magia
- **Intensidade III — ◈◈◈ (3 PA) + 36 Mana:** o mesmo, com um total de 8d6 + Magia
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** 1 aliado com menos da metade da própria Vida máxima
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 15 Mana:** quando esse aliado for atingido por um ataque, o usuário pode usar esta habilidade como Reação pra reduzir o dano daquele ataque à metade (arredondado pra baixo); se o ataque fosse um Crítico, ele passa a valer como acerto normal.
...
- **Intensidade III — ◈◈◈ (3 PA) + 33 Mana:** o alvo recupera 4d6 + Magia de Vida, e remove até 2 condições da lista acima
...
- **Atributo:** Magia | **Alcance:** 8 casas | **Alvos:** 1 aliado
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
- **Intensidade I — 0 PA + 12 Mana:** quando um aliado a até 8 casas estiver prestes a rolar um teste de ataque, o usuário pode usar esta habilidade como Reação pra fazer esse teste rolar com [Vantagem](../glossario.md#vantagem).
- **Intensidade II — 0 PA + 21 Mana:** o mesmo, e se o ataque acertar, ele também causa +1d4 de dano extra.
- **Intensidade III — 0 PA + 30 Mana:** o mesmo, com +2d4 de dano extra.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 6 casas | **Alvos:** o ponto onde uma criatura morreu
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
...
- **Intensidade II — 0 PA + 21 Mana:** o mesmo, com 3d6.
- **Intensidade III — 0 PA + 30 Mana:** o mesmo, com 4d6.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Dano:** Arcano | **Alcance:** 8 casas | **Alvos:** o aliado que caiu, e criaturas hostis em 2 casas de raio dele
- *(Dedicada a Reação — sempre 0 PA; a Intensidade escolhe só quanto Mana gastar)*
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Custo fixo:** ◈ (1 PA) + 24 Mana | **Atributo:** Magia | **Alvos:** o próprio usuário, e até 5 aliados dispostos a até 3 casas
...
- **Intensidade II — 0 PA + 24 Mana:** o mesmo, e a criatura hostil rola esse teste com [Desvantagem](../glossario.md#desvantagem).
- **Intensidade III — 0 PA + 33 Mana:** o mesmo, e o usuário pode escolher qualquer criatura hostil visível, mesmo fora do alcance de 8 casas.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** até 3 aliados a até 6 casas
- **Intensidade I — ◈ (1 PA) + 15 Mana:** por 3 rodadas, a Vida **máxima** de cada alvo aumenta em 1d8 + Magia, e cada um recupera Vida nessa mesma quantidade imediatamente. Quando o efeito termina, o excedente acima do máximo normal desaparece (sem matar ninguém, mesmo que isso reduza a Vida atual).
...
- **Intensidade I — ◈ (1 PA) + 12 Mana:** o alvo ganha +2 no próximo teste de ataque que fizer até o fim do turno dele.
- **Intensidade II — ◈◈ (2 PA) + 21 Mana:** o mesmo, +4, e se acertar, causa +1d6 de dano extra.
...
- **Chave:** [Suporte](../glossario.md#suporte)
- **Atributo:** Magia | **Alcance:** 6 casas | **Alvos:** 1 aliado (ou o próprio usuário)
- **Intensidade I — ◈ (1 PA) + 12 Mana:** o alvo ganha um [Escudo](../glossario.md#escudo) de 1d8 + Magia pontos, que absorve dano antes da Vida ser afetada. Dura até o final da [cena](../glossario.md#cena), ou até ser destruído.
