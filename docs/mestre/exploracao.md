...
|---|---|---|
| **Cauteloso** | 1 | Vantagem pra notar perigo, emboscada ou rastro; ninguém se cansa |
...
As DCs vêm da [tabela de Dificuldades](testes.md#a-tabela) — estrada conhecida é DC 5, floresta densa DC 15, pântano sem trilha DC 20.
...
Duas origens do jogo já concedem resistência a isso ([Deserto](../jogador/origem.md) e Tundra), então a regra precisa existir pra que o traço signifique algo.
