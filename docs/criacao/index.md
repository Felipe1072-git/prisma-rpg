...
Cinco passos, nesta ordem. Ao fim deles você tem uma ficha jogável de nível 1.

Se esta é a sua primeira ficha, comece por um dos [100 Pacotes](../pacotes/index.md): são kits prontos de arma + habilidades que montam um arquétipo (Espadachim, Necromante, Atirador de Elite). **Não são classes e não travam nada** — só poupam você de escolher entre centenas de opções na primeira vez. Você pode sair da trilha do pacote a qualquer nível.
...
Você distribui os oito [Atributos](../jogar/atributos.md) por um dos três métodos abaixo — o grupo escolhe **um** e todo mundo usa o mesmo. Os três estão calibrados pro mesmo teto de poder, e todos deixam cada atributo entre **-2 e +3**.
...
- **1 a 3 Traços Raciais** — capacidades fixas, disponíveis desde o nível 1.

Traços raciais **não** competem com as suas 10 escolhas de habilidade — são um extra da raça.
...
Personagens que passaram por algo fora do comum podem ganhar a marca de um [Tocado](tocado.md) durante a campanha.
